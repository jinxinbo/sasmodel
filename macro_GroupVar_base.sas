...
/*分组方法二:*/
%inc 'E:\python代码及论文\合影\sas代码\c_6_4_GroupVar_macro.sas';
...
run;
data &outIVSum.;
	length VARNAME $50 GRP_VAR cnt_0 cnt_1 tot_0 tot_1 WOE IV 8;
	stop;
run;
...
*/
/*分类变量分组*/
%inc 'E:\python代码及论文\合影\sas代码\c_6_3_CalcWOE_macro.sas';

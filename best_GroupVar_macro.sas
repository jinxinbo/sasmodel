...
data tmp_sort tmp_sort1;
	set tmp_sort;
	if missing(&group_var)^=1 then output tmp_sort;
...
/*		%put 2----------------------------------------------------------------------;*/
/*        */
/*		proc freq data=&in_ds noprint;*/
/*		table &target./out=grouping_tmp_group;*/
/*		run;*/
/**/
/*		data _null_;*/
/*		set grouping_tmp_group;*/
/*		where missing(&target.)^=1;*/
/*		retain num 0;*/
/*		num+1;*/
/*		if num=1 then do;*/
/*			call symputx('target_nonevent_value',&target.);*/
/*			call symputx('target_nonevent_count_all',count);*/
/*		end;*/
/*		else do;*/
/*			call symputx('target_event_value',&target.);*/
/*			call symputx('target_event_count_all',count);*/
/*		end;*/
/*		run;*/
/**/
/*		%put 3------------------------------------------------------------------;*/
/*		%put target_nonevent_count_all:&target_nonevent_count_all.;*/
/*		%put target_event_count_all:&target_event_count_all.;*/
/*		%put 3------------------------------------------------------------------;*/
...
/*			set tmp_varbin_woe;*/
/*			by &group_var. ;*/
/*			retain iv_tmp iv_max tmp_0 tmp_1 cal_varcnt 0;*/
/*			&group_var.=round(&group_var.,1e-10);*/
/*			format &group_var. 20.10;*/
/*			if last.&group_var.=first.&group_var. then do;*/
/*				if &target.=0 then tmp_0=varcnt;*/
/*				else tmp_1=varcnt;*/
/*				cal_varcnt=cal_varcnt+varcnt;*/
/*			end;*/
/*			else do;*/
/*/*			  表示计算每一个类别的iv值，而不是分成两层之后的iv值累加，iv_tmp没什么作用*/*/
/**/
...
/*					and (&split_ds_count.-cal_varcnt+1)>=&all_count.*&min_group_num. */
/*					then do;*/
...
/*				end;*/
/*			end;*/
/*			keep &group_var. cnt_0 cnt_1 tot_0 tot_1 woe iv iv_max cut_off;*/
/*		run;*/
/**/
/*/*		%abort;*/*/
/*/*		data grouping_tmp_woe;*/*/
/*/*		set &split_ds nobs=num_Of_split_ds;*/*/
/*/*		drop cut_off lag_group;*/*/
/*/*		retain target_nonevent_count	0*/*/
/*/*				target_event_count	0*/*/
/*/*				IV_max 0;*/*/
/*/*		&group_var.=round(&group_var.,1e-10);*/*/
/*/*		lag_group=lag(&group_var.);*/*/
/*/*		*/*/
/*/*		/*保证分裂的两组记录数均大于总数的&min_group_num.*/*/*/
/*/*		if _n_>&all_count.*&min_group_num. and (num_Of_split_ds-_n_+1)>=&all_count.*&min_group_num. then do;*/*/
/*/*			/*临界值以下（包括临界值）区间的事件占比和非事件占比*/*/*/
...
/*/*			end;*/*/
/*/*			else do;*/*/
/*/*				nonevent_ratio_lower=target_nonevent_count/&target_nonevent_count_all.;*/*/
/*/*				event_ratio_lower=target_event_count/&target_event_count_all.;*/*/
/*/*			end;*/*/
/*/**/*/
/*/*			/*临界值以上（不包括包括临界值）区间的事件占比和非事件占比*/*/*/
...
/*/*			end;*/*/
/*/*			else do;*/*/
/*/*				nonevent_ratio_upper=(&target_nonevent_count_all.-target_nonevent_count)/&target_nonevent_count_all.;*/*/
/*/*				event_ratio_upper=(&target_event_count_all.-target_event_count)/&target_event_count_all.;*/*/
/*/*			end;*/*/
/*/**/*/
/*/*			WOE_lower=log(event_ratio_lower/nonevent_ratio_lower);*/*/
/*/*			WOE_upper=log(event_ratio_upper/nonevent_ratio_upper);*/*/
/*/**/*/
/*/*			IV=(event_ratio_lower-nonevent_ratio_lower)*WOE_lower+(event_ratio_upper-nonevent_ratio_upper)*WOE_upper;*/*/
/*/**/*/
/*/*			cut_off=sum(&group_var.,lag_group)/2;*/*/
/*/**/*/
/*/*/*			Gini_tmp1=2*((&target_event_count_all.-target_event_count)+target_nonevent_count);*/*/*/
/*/*/*			Gini_tmp2=target_nonevent_count*target_event_count+*/*/*/
/*/*/*				(&target_event_count_all.-target_event_count)*(&target_nonevent_count_all.-target_nonevent_count);*/*/*/
/*/*/*			Gini=(1-(Gini_tmp1+Gini_tmp2)/(&target_event_count_all.*&target_nonevent_count_all.))*100;*/*/*/
/*/**/*/
/*/**/*/
/*/*			if IV>IV_max then do;*/*/
/*/*				IV_max=IV;*/*/
/*/*				call symputx('max_cut_off',cut_off);*/*/
/*/*				call symputx('WOE_lower',WOE_lower);*/*/
/*/*				call symputx('WOE_upper',WOE_upper);*/*/
/*/*				call symputx('IV',IV_max);*/*/
/*/*				call symputx('now_n_',_n_);*/*/
/*/*			end;						*/*/
/*/*		end;*/*/
/*/**/*/
/*/*		if &target.=&target_nonevent_value. then target_nonevent_count+1;*/*/
/*/*		else if  &target.=&target_event_value. then target_event_count+1;*/*/
/*/**/*/
/*/*		run;*/*/
/*;*/
...
/*/*		%put WOE_lower						:&WOE_lower.;*/*/
/*/*		%put WOE_upper						:&WOE_upper.;*/*/
/*		%put IV								:&IV.;*/
/*		%put 4----------------------------------------------------------------------------------------;*/
/**/
/*/*		%if &group_var.=WORKINCOME %then %abort;*/*/
/*		%if &IV>0.001  %then %do;*/
/**/
/*			data split_lower_&split_num.;*/
/*			set &split_ds(where=( round(&group_var.,1e-10)<=&max_cut_off) keep =&group_var &target);*/
/*			run;*/
/**/
/*			data split_upper_&split_num.;*/
/*			set &split_ds(where=( round(&group_var.,1e-10)>&max_cut_off) keep =&group_var &target);*/
/*			run;*/
/**/
/*			%put 5----------------------------------------------------------------------------------------;*/
